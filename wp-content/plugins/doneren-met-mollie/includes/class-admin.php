...
class Dmm_Admin {
    ...
    function plugin_row_meta($links, $file)
    {
        ...
        {
            $row_meta = array(
                'support'    => '<a href="mailto:info@wobbie.nl?subject=Doneren met Mollie" target="_blank">' . esc_html__('Support', 'mollie-forms') . '</a>'
            );
    ...
    public function dmm_export_donations()
    {
        ...
        fputcsv($output, array(
            esc_html_e('Date/time', 'doneren-met-mollie'),
            esc_html_e('Name', 'doneren-met-mollie'),
            esc_html_e('Company name', 'doneren-met-mollie'),
            esc_html_e('Email address', 'doneren-met-mollie'),
            esc_html_e('Phone number', 'doneren-met-mollie'),
            esc_html_e('Address', 'doneren-met-mollie'),
            esc_html_e('Zipcode', 'doneren-met-mollie'),
            esc_html_e('City', 'doneren-met-mollie'),
            esc_html_e('Country', 'doneren-met-mollie'),
            esc_html_e('Project', 'doneren-met-mollie'),
            esc_html_e('Message', 'doneren-met-mollie'),
            esc_html_e('Amount', 'doneren-met-mollie'),
            esc_html_e('Status', 'doneren-met-mollie'),
            esc_html_e('Payment method', 'doneren-met-mollie'),
            esc_html_e('Recurring payment', 'doneren-met-mollie'),
            esc_html_e('Donation ID', 'doneren-met-mollie'),
            esc_html_e('Payment ID', 'doneren-met-mollie'),
        ));
    ...
    public function dmm_page_subscriptions()
    {
        try {
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'cancel' && isset($_GET['subscription']) && check_admin_referer('cancel-subscription_' . $_GET['subscription']))
            {
                ...
                $cancelledSub = $mollie->customers_subscriptions->withParentId($customer->customer_id)->cancel($_GET['subscription']);
